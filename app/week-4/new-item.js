...
const NewItem = () => {
    ...
    return (
        <div className="flex justify-center items-center h-screen">
            <form onSubmit={handleSubmit} className="bg-slate-900 shadow-md  rounded px-15 pt-1 p-2 pb-70 mb-20  w-80">
                <div className="mb-3">
                    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="name">
                        Name:
                    </label>
                    <input
                        className="shadow appearance-none  border black rounded w-full py-1.5 px-3 text-white-900 leading-tight focus:outline-black focus:shadow-outline"
                        id="name"
                        type="text"
                        value={name}
